...
# Really easy program
# Algorithm:
# Traverse and pull all the data from the binary tree into an array - storeInorder
# Sort the array - binaryTreeToBST
# Put all the array data back into a BST through inorder appends - arrayToBST
